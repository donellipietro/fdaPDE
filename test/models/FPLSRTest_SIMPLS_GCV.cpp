...
namespace Test_fPLSR_SIMPLS_GCV
{
                                 ...
                                 std::vector<double> &errors_B)
    {
        ...
        outfile << Y_hat.format(Test_fPLSR_SIMPLS_GCV::CSVFormat);
        outfile.close();
        ...
        outfile << X_hat.format(Test_fPLSR_SIMPLS_GCV::CSVFormat);
        outfile.close();
        ...
        outfile << B_hat.format(Test_fPLSR_SIMPLS_GCV::CSVFormat);
        outfile.close();
    }
 ...
 */
TEST(FPLSR_SIMPLS, Test1_Laplacian_GeostatisticalAtNodes_GCV)
{
    ...
    for (unsigned int i : tests)
    {
        ...
        std::string results_directory = test_directory + "results_GCV/";
        ...
        for (double x = -12.0; x <= 1.0; x += 0.25)
        ...
        Test_fPLSR_SIMPLS_GCV::compareAndExportResults(test_directory,
                                                       results_directory,
                                                       VERBOSE,
                                                       Y_hat,
                                                       X_hat,
    ...
    Test_fPLSR_SIMPLS_GCV::exportErrors(tests_directory,
                                        tests,
                                        VERBOSE,
                                        errors_Y,
                                        errors_X,
