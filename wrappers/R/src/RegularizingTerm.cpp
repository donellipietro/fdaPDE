...
// ConstantCoefficients 2D Order 1
...
// Laplacian 2.5D Order 1
RCPP_EXPOSED_AS(Laplacian_Surface_Order1)
RCPP_EXPOSED_WRAP(Laplacian_Surface_Order1)
RCPP_MODULE(Laplacian_Surface_Order1)
{
  Rcpp::class_<Laplacian_Surface_Order1>("Laplacian_Surface_Order1")
      .constructor<Rcpp::List>()
      // getters
      .method("get_quadrature_nodes", &Laplacian_Surface_Order1::get_quadrature_nodes)
      .method("get_dofs_coordinates", &Laplacian_Surface_Order1::get_dofs_coordinates)
      // setters
      .method("set_dirichlet_bc", &Laplacian_Surface_Order1::set_dirichlet_bc)
      .method("set_forcing_term", &Laplacian_Surface_Order1::set_forcing_term);
}

// Laplacian 3D Order 1
