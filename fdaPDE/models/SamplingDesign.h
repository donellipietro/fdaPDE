...
namespace fdaPDE
{
  namespace models
  {
    ...
    public:
      ...
      void set_spatial_locations(const DMatrix<Derived> &locs) { return; }
    };
    ...
    public:
      ...
      void init_sampling(bool forced = false)
      {
        ...
        for (std::size_t k = 0; k < n; ++k)
        {
          ...
          {
            if (subdomains_(k, l) == 1)
            { // element with ID l belongs to k-th subdomain
